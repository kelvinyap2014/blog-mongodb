...
import io.ky.mb.config.Constants;
import io.ky.mb.BlogApp;
import io.ky.mb.domain.Authority;
import io.ky.mb.domain.User;
import io.ky.mb.repository.AuthorityRepository;
import io.ky.mb.repository.UserRepository;
import io.ky.mb.security.AuthoritiesConstants;
import io.ky.mb.service.MailService;
import io.ky.mb.service.dto.UserDTO;
import io.ky.mb.web.rest.errors.ExceptionTranslator;
import io.ky.mb.web.rest.vm.KeyAndPasswordVM;
import io.ky.mb.web.rest.vm.ManagedUserVM;
import io.ky.mb.service.UserService;
