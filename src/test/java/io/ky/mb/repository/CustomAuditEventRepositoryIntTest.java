...
import io.ky.mb.config.audit.AuditEventConverter;
import io.ky.mb.domain.PersistentAuditEvent;
...
import static io.ky.mb.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
